    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <div>
            <h1 className="text-xl font-bold">AMORGOS TRANSPORT</h1>
        ...
        <nav className="hidden md:flex items-center space-x-6">
          <a 
            href="#services" 
            className="text-sm font-medium hover:text-primary transition-colors animated-border-button"
          >
            Our Services
          </a>
          <a 
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <Button 
            asChild 
            className="bg-taxi hover:bg-taxi-dark text-taxi-contrast"
          >
