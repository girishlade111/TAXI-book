        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <div className="flex space-x-4 text-white">
              {/* Social Media Icons with updated Facebook link */}
              <a href="https://www.facebook.com/share/1ANMNpawWJ/" target="_blank" rel="noopener noreferrer" className="hover:text-taxi transition-colors">
