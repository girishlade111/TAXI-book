...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div 
        className="absolute inset-0 bg-cover bg-center z-0 transform scale-105 motion-safe:animate-[pulse_15s_ease-in-out_infinite]"
        style={{ 
      ...
      <div className="absolute inset-0 z-5 opacity-60">
        <div className="absolute top-1/4 left-1/4 h-2 w-2 rounded-full bg-white animate-pulse" style={{ animationDelay: "0.5s" }}></div>
        <div className="absolute top-1/3 left-1/2 h-3 w-3 rounded-full bg-taxi animate-pulse" style={{ animationDelay: "1.2s" }}></div>
        <div className="absolute top-2/3 left-1/4 h-2 w-2 rounded-full bg-white animate-pulse" style={{ animationDelay: "2.1s" }}></div>
        <div className="absolute top-1/5 right-1/3 h-2 w-2 rounded-full bg-taxi animate-pulse" style={{ animationDelay: "0.7s" }}></div>
        <div className="absolute bottom-1/4 right-1/4 h-3 w-3 rounded-full bg-white animate-pulse" style={{ animationDelay: "1.5s" }}></div>
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 pt-36 pb-24 md:pt-48 md:pb-32 flex flex-col items-center justify-center text-center">
        <div className="max-w-4xl mx-auto backdrop-blur-sm bg-black/10 p-8 rounded-2xl border border-white/10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 mb-12 justify-center">
            <Button 
              asChild 
              className="bg-taxi hover:bg-taxi-dark text-taxi-contrast text-lg px-10 py-7 rounded-xl shadow-[0_0_15px_rgba(255,204,0,0.5)] hover:shadow-[0_0_25px_rgba(255,204,0,0.7)] transition-all duration-300"
              size="lg"
            >
              <a href="#booking">
            ...
            <Button 
              asChild 
              className="bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white border border-white/20 text-lg px-10 py-7 rounded-xl hover:border-white/40 transition-all duration-300"
              size="lg"
              variant="outline"
            >
              <a href="#pricing">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl mt-12">
          ...
          <div className="glass-card animate-float hover:scale-105 transition-transform duration-300" style={{ animationDelay: "0.2s" }}>
            <div className="feature-icon-wrapper">
          ...
          <div className="glass-card animate-float hover:scale-105 transition-transform duration-300" style={{ animationDelay: "0.4s" }}>
            <div className="feature-icon-wrapper">
